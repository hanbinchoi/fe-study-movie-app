...
describe('MovieRankList unit test', () => {
  ...
  test('movies props에 전달된 영화정보의 개수만큼 MovieRankListEntry를 렌더링 해야 합니다.', () => {
    act(() => {
      ReactDOM.render(
        <MovieRankList params={params} movies={mockMovie} />,
        container
      );
    });
...
describe('App integration test', () => {
  const result = [
    {
      ...
      description_full:
        'As the Avengers and their allies have continued to protect the world from threats too large for any one hero to handle, a new danger has emerged from the cosmic shadows: Thanos. A despot of intergalactic infamy, his goal is to collect all six Infinity Stones, artifacts of unimaginable power, and use them to inflict his twisted will on all of reality. Everything the Avengers have fought for has led up to this moment, the fate of Earth and existence has never been more uncertain.',
      small_cover_image:
        'https://yts.lt/assets/images/movies/avengers_infinity_war_2018/small-cover.jpg',
      medium_cover_image:
        'https://yts.lt/assets/images/movies/avengers_infinity_war_2018/medium-cover.jpg',
      large_cover_image:
    ...
    }, // eslint-disable-line
    {
      ...
      description_full:
        "A gritty L.A crime saga which follows the intersecting and often personally connected lives of an elite unit of the LA County Sheriff's Dept. and the state's most successful bank robbery crew as the outlaws plan an impossible heist on the Federal Reserve Bank of downtown Los Angeles.",
      small_cover_image:
        'https://yts.lt/assets/images/movies/den_of_thieves_2018/small-cover.jpg',
      medium_cover_image:
        'https://yts.lt/assets/images/movies/den_of_thieves_2018/medium-cover.jpg',
      large_cover_image:
        'https://yts.lt/assets/images/movies/den_of_thieves_2018/large-cover.jpg',
    }, // eslint-disable-line
  ];
  ...
  test('영화 목록 클릭 시, 현재 영화정보를 업데이트해야 합니다.', async () => {
    ...
    for await (const card of cards) {
      ...
      waitFor(() =>
        expect(currentMovieContainer.querySelector('.title').textContent).toBe(
          title.textContent
        )
      );
    }
